...
//     return '${ApiConstants.baseUrl}/${imagePath.replaceAll('\\', '/')}';
//   }
...
class _BusScreenState extends State<BusScreen> {
  ...
  void _showTicketSelectionPopup(BusTicket ticket) {
    ...
    if (ticket.seatNumbers != null && ticket.seatNumbers!.isNotEmpty) {
      availableSeats = ticket.seatNumbers!
    ...
    if (availableSeats.isEmpty) {
      availableSeats =
          List.generate(ticket.numberOfTickets, (i) => 'Seat ${i + 1}');
    }

    List<String> selectedSeats = [];
    int selectedQuantity = 1; 
    final int maxTickets = availableSeats.length;
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Quantity selector (read-only display — driven by seat selection)
                            Container(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 12,
                                vertical: 10,
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: selectedQuantity > 1
                                              ? () {
                                                  setDialogState(() {
                                                    selectedQuantity--;
                                                    // Remove last selected seat if over limit
                                                    if (selectedSeats.length >
                                                        selectedQuantity) {
                                                      selectedSeats = selectedSeats
                                                          .sublist(0, selectedQuantity);
                                                    }
                                                  });
                                                }
                                              : null,
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          color: selectedQuantity < maxTickets
                                              ? const Color(0xFF1976D2)
                                              : Colors.grey[300],
                                          shape: BoxShape.circle,
                                        ),
                                        child: IconButton(
                                          ...
                                          onPressed: selectedQuantity < maxTickets
                                              ? () {
                                                  setDialogState(() {
                                                    selectedQuantity++;
                                                  });
                            ...
                            // Helper text: selected x / y seats
                            Text(
                              'Selected ${selectedSeats.length} / $selectedQuantity seat(s)',
                              style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.w500,
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '₹ ${(ticket.totalPrice * selectedQuantity).toStringAsFixed(0)}',
                                        style: const TextStyle(
                                          fontSize: 20,
                                          fontWeight: FontWeight.bold,
                                          color: Color(0xFF1976D2),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // BOTTOM: PRICE + SEAT COUNT + SELECT
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(
                              "${ticket.numberOfTickets} seat(s) available",
                              style: const TextStyle(
                                fontSize: 11,
                                color: Colors.blue,
                              ),
