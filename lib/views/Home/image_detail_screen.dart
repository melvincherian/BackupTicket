...
//     final provider = Provider.of<GetMovieTicketProvider>(context, listen: false);
...
//           List<MovieTicket> filteredTickets = provider.allTickets.where((ticket) {
//             // Filter by movie name
//             if (ticket.movieName.toLowerCase() != widget.movieName.toLowerCase()) {
//               return false;
//             }

//             // Filter by selected date
//             if (!_isSameDate(ticket.showDate, _selectedDate)) {
//               return false;
//             }
...
//               Row(
//                 children: [
//                   _buildInfoChip(Icons.airplane_ticket, ticket.ticketCategory, Colors.blue),
//                   const SizedBox(width: 8),
//                   _buildInfoChip(
//                       Icons.confirmation_number, '${ticket.noOfTickets} available', Colors.orange),
//                 ],
//               ),
//               const SizedBox(height: 10),
...
//                           style: TextStyle(
//                               fontSize: 12, fontWeight: FontWeight.bold, color: Colors.blue.shade700),
//                         ),
//                       ),
//                       const SizedBox(width: 6),
//                       Text(
...
//                           Text('₹${ticket.pricePerTicket * selectedQuantity}',
//                               style: const TextStyle(
//                                   fontSize: 18,
//                                   fontWeight: FontWeight.bold,
//                                   color: Colors.green)),
...
//         Text(label,
//             style:
//                 const TextStyle(fontSize: 12, color: Colors.black, fontWeight: FontWeight.w500)),
//       ]),
//     );
//   }
...
class _ImageDetailScreenState extends State<ImageDetailScreen> {
  ...
  Future<void> _loadTickets() async {
    ...
    await provider.fetchAllMovieTickets();
    await provider.fetchAllMovieTicketsWithUserId(_userId.toString());
  }
    ...
    return Scaffold(
      ...
      body: Consumer<GetMovieTicketProvider>(
        builder: (context, provider, child) {
          ...
          // Filter tickets by movie name, date, and search query
          List<MovieTicket> filteredTickets = provider.allTickets.where((
            ticket,
          ) {
            // Filter by movie name
            if (ticket.movieName.toLowerCase() !=
